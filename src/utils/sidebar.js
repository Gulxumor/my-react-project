...
export const sidebar = [
  ...
  },
  {
    ...
    title: 'Subscriptions',
    data: [
      { id: 1, title: 'WebBrain', icon: Icons.Home },
      { id: 2, title: 'WebBrain', icon: Icons.Home },
      { id: 3, title: 'WebBrain', icon: Icons.Home },
      { id: 4, title: 'WebBrain', icon: Icons.Home },
      { id: 5, title: 'WebBrain', icon: Icons.Home },
      { id: 6, title: 'WebBrain', icon: Icons.Home },
      { id: 7, title: 'WebBrain', icon: Icons.Home },
      { id: 8, title: 'WebBrain', icon: Icons.Home },
    ],
  },
  {
    id: 2,
