...
import logo from "../../assets/images/featured/pink.png";
...
import payment from "../../assets/images/new/2.jpg";
  ...
  return (
    <Container>
      <Wrapper>
        <Column>
          ...
          <Text>
            ...
            magna fringilla diam moecenas ultricies mi eget mauris.
          </Text>
        </Column>
        <Column>
      ...
      <Reserved>
        <Payment src={payment} />
        <Text>
          rymo eCommerce @ {new Date().getFullYear()}. All Rights Reserved
        </Text>
      </Reserved>
    </Container>
  );
